    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 flex flex-col">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
            ...
            <div className="flex items-center gap-2.5 w-full sm:w-auto justify-between sm:justify-end">
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 rounded-xl text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-500 active:scale-98 shadow-md shadow-indigo-600/25 transition"
              >
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden backdrop-blur flex-1">
            <div className="grid grid-cols-7 border-b border-slate-800 bg-slate-950/60 text-center text-xs font-semibold text-slate-400 py-2.5">
              <span>Sun</span>
              <span>Mon</span>
              <span>Tue</span>
              <span>Wed</span>
              ...
              {daysInView.map((day) => {
                ...
                return (
                  <div
                    ...
                    className={`min-h-[95px] sm:min-h-[110px] p-2 transition group cursor-pointer hover:bg-slate-800/30 flex flex-col justify-between ${
                  ...
                  >
                    ...
                    <div className="space-y-1 overflow-y-auto max-h-[70px] scrollbar-none flex-1">
                      {dayEvents.map((ev) => (
                        <div
                          key={ev.id}
                          onClick={(e) => handleOpenEditModal(ev, e)}
                          className="text-[11px] p-1.5 rounded-lg bg-indigo-950/60 hover:bg-indigo-900 border border-indigo-800/50 hover:border-indigo-500/50 text-indigo-200 transition truncate flex items-center justify-between gap-1 shadow-sm"
        ...
        <div className="lg:col-span-1">
          <ChatPanel onEventChange={loadEvents} />
        </div>
      </div>
